# BENCHMARK OLLAMA — CLEAN ARCHITECTURE (Aider)
...
- `entities/Task.java` tem imports de Spring? (sim = -3)
- `usecases/*.java` importam `interfaceadapters` ou `frameworks`? (sim = -3)
