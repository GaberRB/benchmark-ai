...
#      .\run.ps1 -Model 2 -Arch 3   (parâmetros diretos)
...
Write-Host ""
Write-Host "  Quando o Aider abrir, mande esta mensagem:" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "  Quando terminar, feche com: /exit" -ForegroundColor DarkGray
Write-Host ""
