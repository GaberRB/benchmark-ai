...
> - Você deve trabalhar **EXCLUSIVAMENTE** no diretório `java-gradle-mode-1/`
> - **NÃO leia, NÃO explore e NÃO referencie** nenhum outro diretório de implementação (`kotlin-*`, `java-mode-*`, `java-quarkus-*`, etc.)
> - **NÃO crie** guias, arquivos de configuração ou diretórios fora de `java-gradle-mode-1/src/`
